...
<form action="{{ route('static.contact-us') }}"
    ...
    <div>
        ...
        <input class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none"
               id="name"
               name="name"
               type="text"
    ...
    <div>
        ...
        <select class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none" id="subject">
    ...
    <div>
        ...
        <textarea class="mt-1 w-full resize-none rounded-lg border-gray-300 focus:border-indigo-500 focus:outline-none"
                  id="message"
                  name="message"
                  rows="4"
